 ...
 * Final Methods
 * A final method cannot be overridden by any subclasses. As mentioned previously, the final modifier prevents a
 ...
 * Final Classes
 * The main purpose of using a class being declared as final is to prevent the class from being subclassed. If a
 * class is marked as final then no class can inherit any feature from the final class.
 * */
